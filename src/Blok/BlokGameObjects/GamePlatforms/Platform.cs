...
namespace BlokGameObjects.GamePlatforms
{
    ...
    public class Platform : DrawableGameComponent
    {
        ...
        private const float SWIPE_FORCE_MULTIPLIER = 35.0f;
        ...
        public float Score { get { return totalScore; } }
        public float ScoreScale { get { return scoreScale; } }
